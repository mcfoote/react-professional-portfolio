    ...
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className="bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900">
        <section className="min-h-screen">
          <nav className="py-10 mb-12 flex justify-between">
            ...
            <ul className="flex items-center">
              ...
              <li>
                <a className="bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-4 py-2 rounded-md ml-8 dark:from-purple-400 dark:to-purple-900" href="#portfolio">Portfolio</a>
              </li>
              <li>
                <a className="bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-4 py-2 rounded-md ml-8 dark:from-purple-400 dark:to-purple-900" href="#">Contact</a>
              </li>
              <li>
                <a className="bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-4 py-2 rounded-md ml-8 dark:from-purple-400 dark:to-purple-900" href="#">Resume</a>
              </li>
            </ul>
          </nav>
          <div className="text-center p-10">
            <h2 className="text-5xl py-2 text-teal-600 font-medium md:text-6xl dark:text-purple-700">Mitchell Foote</h2>
        ...
        <section>
          ...
          <h3 id="portfolio" className="text-center text-4xl py-4 dark:text-orange-600">Portfolio</h3>
